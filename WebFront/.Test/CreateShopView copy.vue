<template>
  <div class="signup-page">
          ...
          <div class="form-group">
            ...
            <div class="logo-upload">
              <div class="upload-preview" @click="triggerFileUpload">
                ...
                <img v-else-if="shop.logo" :src="shop.logo" alt="Logo boutique">
    ...
    <!-- Confettis pour l'effet de succès -->
    <div v-if="showConfetti" class="confetti-container">
      <div v-for="i in 100" :key="i" class="confetti" :style="confettiStyle(i)"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    confettiStyle(i) {
      const colors = ['#0468ff', '#ff7a00', '#20c997', '#ffde59', '#ff6b6b'];
      return {
...
input:focus, select:focus, textarea:focus {
  border-color: #0468ff;
  outline: none;
  box-shadow: 6px 6px 0 rgba(4, 104, 255, 0.2);
...
.spinner {
  width: 40px;
  height: 40px;
  border: 3px solid rgba(4, 104, 255, 0.2);
  border-radius: 50%;
  border-top: 3px solid #0468ff;
...
@keyframes pulse {
  0% { box-shadow: 5px 5px 0 rgba(0,0,0,0.2); }
  50% { box-shadow: 8px 8px 0 rgba(0,0,0,0.3); }
  100% { box-shadow: 5px 5px 0 rgba(0,0,0,0.2); }
}
