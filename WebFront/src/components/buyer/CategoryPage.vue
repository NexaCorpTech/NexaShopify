      ...
      <div class="category-layout">
        ...
        <aside class="category-sidebar">
              ...
              >
                <div class="category-item">
                  ...
                  <i 
                    ...
                    :class="category.open ? 'fas fa-minus' : 'fas fa-plus'"
                  ></i>
                </div>
          ...
          <div class="sidebar-section">
            ...
            <div class="cart-summary">
              <p>{{ cartTotal }} TND - {{ cartItems }} ARTICLES</p>
        ...
        <main class="category-content">
          <div class="breadcrumbs">
            ...
            <span v-if="activeSubcategory"> > {{ activeSubcategory.name }}</span>
          </div>
          
          <h1 class="category-title">{{ activeSubcategory ? activeSubcategory.name : activeCategory.name }}</h1>
          ...
          <div class="filters-bar">
            ...
            <div class="filter-group">
              ...
              <div class="filter-tags">
                <span class="filter-tag" v-for="(filter, index) in activeFilters" :key="index">
                  {{ filter }}
            ...
            <div class="product-card" v-for="(product, index) in products" :key="index">
              ...
              <div class="product-info">
                ...
                <div class="product-actions">
                  <button class="action-button quick-view" @click="quickView(product)">
...
<script>
import BuyerHeader from '@/components/buyer/BuyerHeader.vue';
import BuyerFooter from '@/components/buyer/BuyerFooter.vue';
...
export default {
    ...
    return {
      ...
      products: [
        ...
        },
        {
          ...
          description: "Élégantes et confortables pour une journée au bureau ou une soirée en ville.",
          price: "79,99",
          sizes: [39, 40, 41],
        ...
        },
        {
          ...
          description: "Bottes résistantes en cuir véritable pour un style robuste et élégant.",
          price: "129,99",
          sizes: [38, 39, 40, 41],
  ...
  methods: {
    ...
    addToCart(product) {
      ...
      // Ici vous ajouterez la logique pour mettre à jour le panier
    },
    quickView(product) {
      alert(`Visualisation rapide de ${product.title}`);
      // Ici vous implémenterez le modal de visualisation rapide
    },
    removeFilter(filter) {
  ...
  mounted() {
    ...
    if (this.categories.length > 0) {
      this.toggleCategory(this.categories[5]); // Pulls & Polos
    }
  }
}
</script>
